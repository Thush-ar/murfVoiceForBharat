...
GREETING = (
    "Hi, this is Palo calling for your daily two-minute practice session. "
...
async def outbound_agent(ctx: JobContext):
    ...
    # Deepgram STT → Groq/Qwen LLM → Murf TTS.
    ...
    try:
        ...
        # If the number is busy, declines, or never answers, it raises instead.
